...
const CARRO_QUESTIONS = [
  ...
  },
  {
    id: 'g3-30',
    group: 'III',
    prompt: 'Que indica la senal circular de borde rojo que se muestra?',
    image: '/senales/siga-de-frente.svg',
    imageAlt: 'Senal de transito para identificar',
    options: [
      'Obligacion de seguir de frente; no se permite girar',
      'Prohibicion de continuar de frente',
      'Recomendacion de seguir si la via esta libre',
      'Via de un solo sentido hacia atras',
    ],
    answer: 0,
    explanation:
      'Es una senal reglamentaria que obliga a seguir de frente: no se permite girar en esa interseccion.',
  },
  {
    id: 'g3-31',
    group: 'III',
    prompt: 'Que indica la senal circular de borde rojo que se muestra?',
    image: '/senales/giro-obligatorio-izquierda.svg',
    imageAlt: 'Senal de transito para identificar',
    options: [
      'Giro a la izquierda prohibido',
      'Giro obligatorio unicamente a la izquierda',
      'Curva peligrosa hacia la izquierda',
      'Carril exclusivo para girar a la derecha',
    ],
    answer: 1,
    explanation: 'La senal indica que en esa interseccion solo se permite girar a la izquierda.',
  },
  {
    id: 'g3-32',
    group: 'III',
    prompt: 'Que indica la senal circular de borde rojo que se muestra?',
    image: '/senales/giro-obligatorio-derecha.svg',
    imageAlt: 'Senal de transito para identificar',
    options: [
      'Giro a la derecha prohibido',
      'Interseccion en T hacia la derecha',
      'Giro obligatorio unicamente a la derecha',
      'Curva peligrosa hacia la derecha',
    ],
    answer: 2,
    explanation: 'La senal indica que en esa interseccion solo se permite girar a la derecha.',
  },
  {
    id: 'g3-33',
    group: 'III',
    prompt: 'Que indica la senal circular de borde rojo que se muestra?',
    image: '/senales/prohibido-girar-derecha.svg',
    imageAlt: 'Senal de transito para identificar',
    options: [
      'Giro a la derecha obligatorio',
      'Solo las motos pueden girar a la derecha',
      'Curva cerrada hacia la derecha',
      'Giro a la derecha prohibido para todos los vehiculos',
    ],
    answer: 3,
    explanation:
      'Prohibe el giro a la derecha a todos los vehiculos; el conductor debe continuar de frente o girar a la izquierda si se permite.',
  },
  {
    id: 'g3-34',
    group: 'III',
    prompt: 'Que indica la senal circular de borde rojo que se muestra?',
    image: '/senales/prohibido-giro-en-u.svg',
    imageAlt: 'Senal de transito para identificar',
    options: [
      'Prohibido hacer giro en U para devolverse',
      'Giro en U permitido solo a buses',
      'Curva y contracurva adelante',
      'Glorieta obligatoria adelante',
    ],
    answer: 0,
    explanation:
  ...
  },
  {
    ...
    group: 'III',
    prompt: 'Que indica la senal circular de borde rojo que se muestra?',
    image: '/senales/prohibido-vehiculos-automotores.svg',
    imageAlt: 'Senal de transito para identificar',
    options: [
      'Via exclusiva para automoviles',
      'Circulacion prohibida para todos los vehiculos automotores',
      'Zona de parqueo de vehiculos',
      'Prohibida solo la circulacion de camiones',
    ],
    answer: 1,
    explanation: 'Prohibe la circulacion de todos los vehiculos automotores por esa via.',
  },
  {
    id: 'g3-36',
    group: 'III',
    prompt: 'Que indica la senal circular de borde rojo que se muestra?',
    image: '/senales/prohibido-vehiculos-carga.svg',
    imageAlt: 'Senal de transito para identificar',
    options: [
      'Zona exclusiva de cargue y descargue',
      'Prohibida la circulacion de buses',
      'Circulacion prohibida para vehiculos de carga',
      'Peso maximo permitido por eje',
    ],
    answer: 2,
    explanation: 'Prohibe la circulacion de vehiculos de carga (camiones) por esa via.',
  },
  {
    id: 'g3-37',
    group: 'III',
    prompt: 'Que indica la senal circular de borde rojo que se muestra?',
    image: '/senales/prohibido-peatones.svg',
    imageAlt: 'Senal de transito para identificar',
    options: [
      'Zona de cruce peatonal',
      'Via peatonal exclusiva',
      'Precaucion por peatones en la via',
      'Circulacion de peatones prohibida en esa via',
    ],
    answer: 3,
    explanation:
  ...
  },
  {
    ...
    group: 'III',
    prompt: 'Que indica la senal circular de borde rojo que se muestra?',
    image: '/senales/prohibido-motocicletas.svg',
    imageAlt: 'Senal de transito para identificar',
    options: [
      'Circulacion de motocicletas prohibida en esa via',
      'Carril exclusivo para motocicletas',
      'Parqueadero de motocicletas',
      'Prohibida la circulacion de bicicletas',
    ],
    answer: 0,
    explanation: 'Prohibe la circulacion de motocicletas por esa via.',
  },
  {
    id: 'g3-39',
    group: 'III',
    prompt: 'Que indica la senal circular de borde rojo que se muestra?',
    image: '/senales/prohibido-adelantar.svg',
    imageAlt: 'Senal de transito para identificar',
    options: [
      'Adelantamiento permitido solo por la derecha',
      'Prohibido adelantar o rebasar a otro vehiculo',
      'Via de doble calzada',
      'Prohibido cambiar de carril',
    ],
    answer: 1,
    explanation: 'Prohibe adelantar o rebasar a otro vehiculo en ese tramo de la via.',
  },
  {
    id: 'g3-40',
    group: 'III',
    prompt: 'Que indica la senal circular de borde rojo que se muestra?',
    image: '/senales/prohibido-parquear-detener.svg',
    imageAlt: 'Senal de transito para identificar',
    options: [
      'Prohibido parquear, pero se puede detener un momento',
      'Parqueo permitido con limite de tiempo',
      'Prohibido parquear y tambien detenerse, asi sea por unos segundos',
      'Zona exclusiva de taxis',
    ],
    answer: 2,
    explanation:
  ...
  },
  {
    ...
    group: 'III',
    prompt: 'Que indica la senal circular de borde rojo que se muestra?',
    image: '/senales/prohibido-pitar.svg',
    imageAlt: 'Senal de transito para identificar',
    options: [
      'Zona de uso obligatorio del pito',
      'Prohibido el paso de vehiculos ruidosos',
      'Reduccion de velocidad por ruido',
      'Prohibido usar el pito o la bocina, salvo emergencia',
    ],
    answer: 3,
    explanation: 'Prohibe el uso del pito o la bocina en esa zona, salvo en caso de emergencia.',
  },
  {
    id: 'g3-42',
    group: 'III',
    prompt: 'Que indica la senal circular de borde rojo que se muestra?',
    image: '/senales/altura-maxima.svg',
    imageAlt: 'Senal de transito para identificar',
    options: [
      'Altura maxima permitida; ningun vehiculo mas alto puede pasar',
      'Ancho maximo permitido del vehiculo',
      'Altura libre de un puente peatonal',
      'Velocidad maxima dentro de tuneles',
    ],
    answer: 0,
    explanation:
  ...
  },
  {
    ...
    group: 'III',
    prompt: 'Que indica la senal circular de borde rojo que se muestra?',
    image: '/senales/ancho-maximo.svg',
    imageAlt: 'Senal de transito para identificar',
    options: [
      'Altura maxima permitida del vehiculo',
      'Ancho maximo permitido; ningun vehiculo mas ancho puede pasar',
      'Ancho del carril en metros',
      'Distancia minima entre vehiculos',
    ],
    answer: 1,
    explanation:
  ...
  },
  {
    id: 'g3-44',
    group: 'III',
    prompt: 'Que advierte la senal romboidal amarilla que se muestra?',
    image: '/senales/curva-peligrosa-izquierda.svg',
    imageAlt: 'Senal de transito para identificar',
    options: [
      'Giro obligatorio a la izquierda',
      'Prohibido girar a la izquierda',
      'Curva peligrosa hacia la izquierda; reducir la velocidad',
      'Interseccion hacia la izquierda',
    ],
    answer: 2,
    explanation:
      'Advierte una curva peligrosa hacia la izquierda; el conductor debe reducir la velocidad y mantenerse en su carril.',
  },
  {
    id: 'g3-45',
    group: 'III',
    prompt: 'Que advierte la senal romboidal amarilla que se muestra?',
    image: '/senales/curva-y-contracurva.svg',
    imageAlt: 'Senal de transito para identificar',
    options: [
      'Via en zigzag por obras',
      'Glorieta proxima',
      'Carril que se divide en dos',
      'Una curva seguida de otra en sentido contrario',
    ],
    answer: 3,
    explanation:
  ...
  },
  {
    ...
    group: 'III',
    prompt: 'Que advierte la senal romboidal amarilla que se muestra?',
    image: '/senales/interseccion.svg',
    imageAlt: 'Senal de transito para identificar',
    options: [
      'Cruce de vias a nivel mas adelante',
      'Glorieta obligatoria',
      'Semaforo adelante',
      'Bifurcacion de la via en Y',
    ],
    answer: 0,
    explanation:
      'Advierte un cruce de vias a nivel adelante; reducir la velocidad y estar atento a los vehiculos de la via transversal.',
  },
  {
    id: 'g3-47',
    group: 'III',
    prompt: 'Que advierte la senal romboidal amarilla que se muestra?',
    image: '/senales/semaforo.svg',
    imageAlt: 'Senal de transito para identificar',
    options: [
      'Interseccion sin senalizar',
      'Proximidad de un semaforo; prepararse para detenerse',
  ...
  },
  {
    ...
    group: 'III',
    prompt: 'Que advierte la senal romboidal amarilla que se muestra?',
    image: '/senales/resalto.svg',
    imageAlt: 'Senal de transito para identificar',
    options: [
      'Hueco o depresion en la calzada',
      'Puente angosto adelante',
      'Resalto o reductor de velocidad sobre la via',
      'Banda sonora de alerta',
    ],
    answer: 2,
    explanation:
  ...
  },
  {
    ...
    group: 'III',
    prompt: 'Que advierte la senal romboidal amarilla que se muestra?',
    image: '/senales/pare-adelante.svg',
    imageAlt: 'Senal de transito para identificar',
    options: [
      'Obligacion de detenerse en ese mismo punto',
      'Ceda el paso adelante',
      'Fin de la via principal',
      'Anticipa una senal de PARE mas adelante',
    ],
    answer: 3,
    explanation:
  ...
  },
  {
    ...
    group: 'III',
    prompt: 'Que advierte la senal romboidal amarilla que se muestra?',
    image: '/senales/ceda-el-paso-adelante.svg',
    imageAlt: 'Senal de transito para identificar',
    options: [
      'Anticipa una senal de Ceda el Paso mas adelante',
      'Anticipa una senal de PARE',
      'Via prioritaria adelante',
      'Prohibido el paso adelante',
    ],
    answer: 0,
    explanation:
  ...
  },
  {
    ...
    group: 'III',
    prompt: 'Que advierte la senal romboidal amarilla que se muestra?',
    image: '/senales/tunel.svg',
    imageAlt: 'Senal de transito para identificar',
    options: [
      'Paso a desnivel o puente',
      'Proximidad de un tunel; encender las luces y no adelantar',
      'Zona de derrumbes',
  ...
  },
  {
    ...
    group: 'III',
    prompt: 'Que advierte la senal romboidal amarilla que se muestra?',
    image: '/senales/zona-derrumbe.svg',
    imageAlt: 'Senal de transito para identificar',
    options: [
      'Via en mal estado por huecos',
      'Pendiente pronunciada adelante',
      'Zona propensa a derrumbes o caida de rocas',
      'Zona de inundacion frecuente',
    ],
    answer: 2,
    explanation:
  ...
  },
  {
    ...
    group: 'III',
    prompt: 'Que advierte la senal romboidal amarilla que se muestra?',
    image: '/senales/superficie-deslizante.svg',
    imageAlt: 'Senal de transito para identificar',
    options: [
      'Via en construccion',
      'Zona de vientos cruzados',
      'Pavimento en mal estado',
      'Via que puede ser deslizante, sobre todo con lluvia',
    ],
    answer: 3,
    explanation:
  ...
  },
  {
    ...
    group: 'III',
    prompt: 'Que advierte la senal romboidal amarilla que se muestra?',
    image: '/senales/maquinaria-agricola.svg',
    imageAlt: 'Senal de transito para identificar',
    options: [
      'Posible presencia de maquinaria agricola en la via',
      'Zona de cruce de ganado',
      'Via rural sin pavimentar',
  ...
  },
  {
    id: 'g3-55',
    group: 'III',
    prompt: 'Que advierte la senal pentagonal verde que se muestra?',
    image: '/senales/zona-escolar.svg',
    imageAlt: 'Senal de transito para identificar',
    options: [
      'Zona deportiva o recreativa',
      'Zona escolar; reducir la velocidad y ceder el paso a los estudiantes',
      'Paradero de bus escolar exclusivo',
      'Cruce peatonal comun',
    ],
    answer: 1,
    explanation:
  ...
  },
  {
    ...
    group: 'III',
    prompt: 'Que advierte la senal romboidal amarilla que se muestra?',
    image: '/senales/animales-en-via.svg',
    imageAlt: 'Senal de transito para identificar',
    options: [
      'Zona de reserva natural protegida',
      'Prohibido el paso de vehiculos de traccion animal',
      'Posible cruce de animales en la via',
      'Finca ganadera adelante',
    ],
    answer: 2,
    explanation:
